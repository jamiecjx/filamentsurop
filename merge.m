...
for d=66:88
    w1 = load(sprintf('f0_200_f1_300_d_%i_df_1_phase_0_ndts_400.mat', d));
...
% evalarray = zeros(100, 23, 6);
% 
% for f=401:500
%     data = load(sprintf("ls_f_%i_df_1_d0_88_d1_66_dd_-1_phase_5.000000e-01_ndts_400.mat", f));
%     evalarraytemp = data.evalarray;
%     evalarray(f-400, :, :) = evalarraytemp;
% end
% d0=88
% d1=66
% f0=401
...
% for d=66:88
%     file1='f0_200_f1_300_d_%i_df_1_phase_0_ndts_400.mat'
%     file2='f0_250_f1_300_d_%i_df_1_phase_0_ndts_400.mat'
%     w1 = load(sprintf(file1, d));
%     w2 = load(sprintf(file2, d));
%     % delete(sprintf(file1, d));
%     % delete(sprintf(file2, d));
...
% 
% 
%     norm(cont1(:, 51) - cont2(:, 1))
%     continuationarray = cont1;
%     continuationarray(:, 51:end) = cont2;
%     save(sprintf('f0_%i_f1_%i_d_%i_df_%i_phase_%i_ndts_%i.mat',f0,f1,d,df,phase,ndts), ...
%     "continuationarray", "f0", "f1", "d", "df", "phase", "ndts");
% end