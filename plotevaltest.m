...
% data = load('ls_f0_41_f1_400_df_1_d0_88_d1_66_dd_-1_phase_5.000000e-01_ndts_400.mat')
% we1 = data.evalarray;
% data2 = load('ls_f0_401_f1_500_df_1_d0_88_d1_66_dd_-1_phase_5.000000e-01_ndts_400.mat')
% 
% we2 = data2.evalarray;
% size(we1)
% size(we2)
